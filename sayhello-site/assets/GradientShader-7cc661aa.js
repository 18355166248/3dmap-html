    ...
    (this.time = o),
      (this.options = Object.assign(
        {},
        {
          ...
          needRotate: !1,
          rotateSpeed: 0.001,
          material: new h({ transparent: !0, opacity: 1, depthTest: !0 }),
        },
        e
      ));
    let a = new p(this.options.width, this.options.width),
      t = new f(a, this.options.material);
    t.rotateX(-Math.PI / 2),
...
class v {
  ...
  init(o) {
    let { uColor1: e, uColor2: a, dir: t, size: s } = this.config,
      l = { x: 1, y: 2, z: 3 };
    o.onBeforeCompile = (i) => {
      (this.shader = i),
        (i.uniforms = {
          ...i.uniforms,
          uColor1: { value: new n(e) },
          uColor2: { value: new n(a) },
          uDir: { value: l[t] },
          uSize: { value: s },
        }),
