...
import { M as I, R as Q } from "./index-1453e2ee.js";
import { G as h } from "./Grid-77f5dd1e.js";
import { g as n } from "./index-4db78ffb.js";
import { _ as k } from "./_plugin-vue_export-helper-c27b6911.js";
import { g as x, h as S, o as U, c as m } from "./index-9ee60282.js";
const G =
  ...
  y = "/sayhello-site/assets/focus_bg-608c1264.png",
  P =
  ...
  v = "/sayhello-site/assets/focus_move_bg-cf41417a.png";
class R extends I {
  constructor(A) {
    super(A, { isOrthographic: !1 }),
      (this.scene.fog = new w(0, 1, 150)),
      ...
      this.initAssets(() => {
        this.initRender(), this.initModel();
      });
  }
  initAssets(A) {
    (this.assets = new Q()),
      this.assets.loadAll([
        { type: "Texture", name: "focusArrows", path: G },
        { type: "Texture", name: "focusBar", path: O },
        { type: "Texture", name: "focusBg", path: y },
        { type: "Texture", name: "focusMidQuan", path: P },
        { type: "Texture", name: "focusMoveBg", path: v },
      ]),
  ...
  initRender() {
    (this.renderer.instance.shadowMap.enabled = !0),
      (this.renderer.instance.shadowMap.type = D);
  }
  initModel() {
    new h(this, {
      gridSize: 100,
    ...
    let e = 16776960,
      c = new t(
        A,
        new a({
          map: this.assets.getResource("focusArrows"),
          color: e,
          transparent: !0,
          fog: !1,
          side: o,
      ...
      i = new t(
        g,
        new a({
          map: this.assets.getResource("focusBar"),
          color: e,
          transparent: !0,
          fog: !1,
          side: o,
    ...
    let p = new t(
        A,
        new a({
          map: this.assets.getResource("focusBg"),
          color: e,
          transparent: !0,
          fog: !1,
          side: o,
      ...
      B = new t(
        A,
        new a({
          map: this.assets.getResource("focusMidQuan"),
          color: e,
          transparent: !0,
          fog: !1,
          side: o,
      ...
      r = new t(
        A,
        new a({
          map: this.assets.getResource("focusMoveBg"),
          color: e,
          transparent: !0,
          fog: !1,
          side: o,
    ...
    r.scale.setScalar(l),
      ...
      n.to(r.material, { opacity: 0, duration: 2.5, repeat: -1, ease: "none" });
  }
  update() {
...
const T = { id: "canvas" },
  V = {
    ...
    setup(d) {
      ...
      return (
        x(() => {
          A = new R(document.getElementById("canvas"));
        }),
        S(() => {
          A && A.destroy();
        }),
  ...
  Y = k(V, [["__scopeId", "data-v-b5b70ac5"]]);
export { Y as default };
