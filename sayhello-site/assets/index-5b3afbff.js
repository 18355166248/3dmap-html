 ...
 */ var ne =
  ...
  p = "srgb",
  _ = "srgb-linear",
  N = { DEFAULT: 0, KEEP_MAX_DEPTH: 1, DISCARD_MAX_DEPTH: 2 },
  Ce = { DEPTH: 0, LUMA: 1, COLOR: 2 },
  I = { NONE: 0, DEPTH: 1, CONVOLUTION: 2 },
  d = {
  ...
  je = { DISABLED: 0, DEPTH: 1, CUSTOM: 2 },
  k = { LOW: 0, MEDIUM: 1, HIGH: 2, ULTRA: 3 },
  Be = Number(q.replace(/\D+/g, "")),
  Se = Be >= 152,
  Ze = new Map([
    [De, _],
    [Ee, p],
...
function F(e) {
  return e === null ? null : Se ? e.outputColorSpace : Ze.get(e.outputEncoding);
}
function y(e, t) {
  e !== null && (Se ? (e.colorSpace = t) : (e.encoding = qe.get(t)));
}
function Q(e) {
  return Be < 154 ? e.replace("colorspace_fragment", "encodings_fragment") : e;
}
var _e = `#ifdef FRAMEBUFFER_PRECISION_HIGH
  ...
  tt = class extends B {
    constructor(e = new le()) {
      super({
        ...
        (this.fragmentShader = Q(this.fragmentShader)),
...
#include <dithering_fragment>
  ...
  Te = class extends B {
    constructor() {
      super({
        name: "CopyMaterial",
        uniforms: { inputBuffer: new l(null), opacity: new l(1) },
        blending: T,
        toneMapped: !1,
        depthWrite: !1,
        depthTest: !1,
...
if(keep){gl_FragColor=texture2D(inputBuffer,vUv);}else{discard;}}`,
  ot = class extends B {
    constructor() {
      super({
        ...
        defines: {
          ...
          DEPTH_PACKING_0: "0",
          DEPTH_PACKING_1: "0",
          DEPTH_TEST_STRATEGY: N.KEEP_MAX_DEPTH,
        },
        uniforms: {
          inputBuffer: new l(null),
          depthBuffer0: new l(null),
          depthBuffer1: new l(null),
          cameraNearFar: new l(new v(1, 1)),
        },
        blending: T,
        toneMapped: !1,
        depthWrite: !1,
    ...
    set keepFar(e) {
      this.maxDepthStrategy = e ? N.KEEP_MAX_DEPTH : N.DISCARD_MAX_DEPTH;
    }
    getMaxDepthStrategy() {
      return this.maxDepthStrategy;
    }
  ...
  ct = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
  ...
  ut = class extends B {
    constructor() {
      super({
        ...
        uniforms: { inputBuffer: new l(null), texelSize: new l(new v()) },
        blending: T,
        toneMapped: !1,
        depthWrite: !1,
        depthTest: !1,
  ...
  ht = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
vec4 delta;vec3 c=texture2D(inputBuffer,vUv).rgb;vec3 cLeft=texture2D(inputBuffer,vUv0).rgb;vec3 t=abs(c-cLeft);delta.x=max(max(t.r,t.g),t.b);vec3 cTop=texture2D(inputBuffer,vUv1).rgb;t=abs(c-cTop);delta.y=max(max(t.r,t.g),t.b);vec2 edges=step(threshold,delta.xy);if(dot(edges,vec2(1.0))==0.0){discard;}vec3 cRight=texture2D(inputBuffer,vUv2).rgb;t=abs(c-cRight);delta.z=max(max(t.r,t.g),t.b);vec3 cBottom=texture2D(inputBuffer,vUv3).rgb;t=abs(c-cBottom);delta.w=max(max(t.r,t.g),t.b);vec2 maxDelta=max(delta.xy,delta.zw);vec3 cLeftLeft=texture2D(inputBuffer,vUv4).rgb;t=abs(c-cLeftLeft);delta.z=max(max(t.r,t.g),t.b);vec3 cTopTop=texture2D(inputBuffer,vUv5).rgb;t=abs(c-cTopTop);delta.w=max(max(t.r,t.g),t.b);maxDelta=max(maxDelta.xy,delta.zw);float finalDelta=max(maxDelta.x,maxDelta.y);edges*=step(finalDelta,LOCAL_CONTRAST_ADAPTATION_FACTOR*delta.xy);gl_FragColor=vec4(edges,0.0,1.0);
  ...
  dt = `uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
#if EDGE_DETECTION_MODE != 0
varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;
#endif
...
gl_Position=vec4(position.xy,1.0,1.0);}`,
  ft = class extends B {
    constructor(e = new v(), t = Ce.COLOR) {
      super({
        name: "EdgeDetectionMaterial",
        defines: {
          THREE_REVISION: q.replace(/\D+/g, ""),
...
#include <dithering_fragment>
  ...
  vt = class extends B {
    constructor(e, t, i, r, s = !1) {
      super({
        ...
        uniforms: {
          inputBuffer: new l(null),
          depthBuffer: new l(null),
          resolution: new l(new v()),
          texelSize: new l(new v()),
          cameraNear: new l(0.3),
          cameraFar: new l(1e3),
          aspect: new l(1),
          time: new l(0),
    ...
    setShaderParts(e) {
      return (
        (this.fragmentShader = gt
          .replace(d.FRAGMENT_HEAD, e.get(d.FRAGMENT_HEAD) || "")
          .replace(d.FRAGMENT_MAIN_UV, e.get(d.FRAGMENT_MAIN_UV) || "")
          .replace(d.FRAGMENT_MAIN_IMAGE, e.get(d.FRAGMENT_MAIN_IMAGE) || "")),
        (this.vertexShader = At.replace(
          d.VERTEX_HEAD,
          e.get(d.VERTEX_HEAD) || ""
        ).replace(d.VERTEX_MAIN_SUPPORT, e.get(d.VERTEX_MAIN_SUPPORT) || "")),
        (this.fragmentShader = Q(this.fragmentShader)),
        (this.needsUpdate = !0),
        this
      );
...
gl_FragColor=vec4(l);
  ...
  mt = class extends B {
    constructor(e = !1, t = null) {
      super({
        ...
        defines: { THREE_REVISION: q.replace(/\D+/g, "") },
        uniforms: {
          inputBuffer: new l(null),
          threshold: new l(0),
          smoothing: new l(1),
  ...
  wt = `#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
function yt() {
  if (b === null) {
    ...
    (b = new Je()),
      b.setAttribute !== void 0
        ? (b.setAttribute("position", new W(e, 3)),
          b.setAttribute("uv", new W(t, 2)))
        : (b.addAttribute("position", new W(e, 3)),
          b.addAttribute("uv", new W(t, 2)));
  }
  return b;
}
var S = class Me {
    constructor(t = "Pass", i = new ce(), r = It) {
      (this.name = t),
        (this.renderer = null),
        (this.scene = i),
        (this.camera = r),
    ...
    set fullscreenMaterial(t) {
      ...
      i !== null
        ...
        : ((i = new ke(yt(), t)),
          (i.frustumCulled = !1),
          this.scene === null && (this.scene = new ce()),
          this.scene.add(i),
          (this.screen = i));
    }
  ...
  Pt = class extends S {
    constructor(e, t = !0) {
      super("CopyPass"),
        (this.fullscreenMaterial = new Te()),
        (this.needsSwap = !1),
        (this.renderTarget = e),
        e === void 0 &&
          ((this.renderTarget = new w(1, 1, {
            minFilter: L,
            magFilter: L,
            stencilBuffer: !1,
            depthBuffer: !1,
    ...
    initialize(e, t, i) {
      i !== void 0 &&
        ...
        i !== R
          ...
          : F(e) === p && y(this.renderTarget.texture, p));
    }
  },
  Rt = class extends S {
    constructor() {
  ...
  Ie = class extends S {
    constructor(e, t, i = null) {
      super("RenderPass", e, t),
        (this.needsSwap = !1),
        (this.clearPass = new Y()),
        (this.overrideMaterialManager = i === null ? null : new de(i)),
    ...
    set overrideMaterial(e) {
      ...
      e !== null
        ? t !== null
          ? t.setMaterial(e)
          : (this.overrideMaterialManager = new de(e))
  ...
  ye = class extends S {
    constructor(
      ...
      super("DepthPass"),
        (this.needsSwap = !1),
        (this.renderPass = new Ie(e, t, new Ne({ depthPacking: K })));
      const c = this.renderPass;
      (c.skipShadowMapUpdate = !0), (c.ignoreBackground = !0);
      const u = c.clearPass;
      (u.overrideClearColor = new O(16777215)),
        (u.overrideClearAlpha = 1),
        (this.renderTarget = i),
        this.renderTarget === void 0 &&
          ((this.renderTarget = new w(1, 1, { minFilter: j, magFilter: j })),
          (this.renderTarget.texture.name = "DepthPass.Target"));
      const g = (this.resolution = new x(this, a, o, r));
...
function bt(e, t, i) {
    ...
    throw new Error(`Could not find mainImage or mainUv function (${t.name})`);
  {
    const o = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g,
      c = i.shaderParts;
    let u = c.get(d.FRAGMENT_HEAD) || "",
      g = c.get(d.FRAGMENT_MAIN_UV) || "",
      f = c.get(d.FRAGMENT_MAIN_IMAGE) || "",
      A = c.get(d.VERTEX_HEAD) || "",
      E = c.get(d.VERTEX_MAIN_SUPPORT) || "";
    const M = new Set(),
      C = new Set();
    if (
      (a &&
...
`),
      ...
      const m = /mainSupport *\([\w\s]*?uv\s*?\)/.test(s);
      (E += `	${e}MainSupport(`),
        (E += m
          ? `vUv);
`
...
`);
      for (const D of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const z of D[1].split(/\s*,\s*/))
          i.varyings.add(z), M.add(z), C.add(z);
      for (const D of s.matchAll(o)) C.add(D[1]);
    }
    for (const m of r.matchAll(o)) C.add(m[1]);
    for (const m of t.defines.keys()) C.add(m.replace(/\([\w\s,]*\)/g, ""));
    for (const m of t.uniforms.keys()) C.add(m);
    C.delete("while"),
      C.delete("for"),
      C.delete("if"),
      t.uniforms.forEach((m, D) =>
        i.uniforms.set(e + D.charAt(0).toUpperCase() + D.slice(1), m)
      ),
      t.defines.forEach((m, D) =>
        i.defines.set(e + D.charAt(0).toUpperCase() + D.slice(1), m)
      );
    const G = new Map([
      ["fragment", r],
      ["vertex", s],
    ...
    he(e, C, i.defines),
      ...
      (s = G.get("vertex"));
    const H = t.blendMode;
    if ((i.blendModes.set(H.blendFunction, H), n)) {
	...
	`),
      ...
      (f += `${e}MainImage(color0, UV, `),
        i.attributes & I.DEPTH &&
          m.test(r) &&
          ((f += "depth, "), (i.readDepth = !0)),
        (f += `color1);
	`);
      const D = e + "BlendOpacity";
      i.uniforms.set(D, H.opacity),
        (f += `color0 = blend${H.blendFunction}(color0, color1, ${D});
...
`),
      s !== null &&
        (A +=
          ...
          `
`),
      c.set(d.FRAGMENT_HEAD, u),
      c.set(d.FRAGMENT_MAIN_UV, g),
      c.set(d.FRAGMENT_MAIN_IMAGE, f),
      c.set(d.VERTEX_HEAD, A),
      c.set(d.VERTEX_MAIN_SUPPORT, E),
      t.extensions !== null)
    )
...
var Ii = class extends S {
    constructor(e, ...t) {
      super("EffectPass"),
        (this.fullscreenMaterial = new vt(null, null, null, e)),
    ...
    updateMaterial() {
      ...
      for (const a of this.effects)
        if (a.blendMode.blendFunction === h.DST)
          e.attributes |= a.getAttributes() & I.DEPTH;
        else {
          if (e.attributes & a.getAttributes() & I.CONVOLUTION)
            throw new Error(`Convolution effects cannot be merged (${a.name})`);
          bt("e" + t++, a, e);
        }
      let i = e.shaderParts.get(d.FRAGMENT_HEAD),
        r = e.shaderParts.get(d.FRAGMENT_MAIN_IMAGE),
        s = e.shaderParts.get(d.FRAGMENT_MAIN_UV);
      const n = /\bblend\b/g;
      for (const a of e.blendModes.values())
        i +=
          a.getShaderCode().replace(n, `blend${a.blendFunction}`) +
          `
`;
...
` + s),
        ...
        e.shaderParts.set(d.FRAGMENT_HEAD, i),
        e.shaderParts.set(d.FRAGMENT_MAIN_IMAGE, r),
        e.shaderParts.set(d.FRAGMENT_MAIN_UV, s);
...
#`
    ...
    render(e, t, i, r, s) {
      for (const n of this.effects) n.update(e, t, r);
      if (!this.skipRendering || this.renderToScreen) {
        const n = this.fullscreenMaterial;
        (n.inputBuffer = t.texture),
          (n.time += r * this.timeScale),
  ...
  Pe = class extends S {
    constructor({
      ...
      super("KawaseBlurPass"),
        (this.renderTargetA = new w(1, 1, { depthBuffer: !1 })),
        (this.renderTargetA.texture.name = "Blur.Target.A"),
        (this.renderTargetB = this.renderTargetA.clone()),
        (this.renderTargetB.texture.name = "Blur.Target.B");
      const a = (this.resolution = new x(this, s, n, t));
      a.addEventListener("change", (o) =>
        this.setSize(a.baseWidth, a.baseHeight)
      ),
        (this._blurMaterial = new tt()),
        (this._blurMaterial.kernelSize = e),
        (this.copyMaterial = new Te());
    }
    getResolution() {
      return this.resolution;
    }
    ...
    initialize(e, t, i) {
      i !== void 0 &&
        ...
        i !== R
          ...
          : F(e) === p &&
            (y(this.renderTargetA.texture, p),
            y(this.renderTargetB.texture, p)));
    }
  ...
  Ut = class extends S {
    constructor({
      ...
      super("LuminancePass"),
        (this.fullscreenMaterial = new mt(i, t)),
        (this.needsSwap = !1),
        (this.renderTarget = e),
        this.renderTarget === void 0 &&
          ((this.renderTarget = new w(1, 1, { depthBuffer: !1 })),
          (this.renderTarget.texture.name = "LuminancePass.Target"));
      const c = (this.resolution = new x(this, a, o, r));
  ...
  Ot = class extends S {
    ...
    render(e, t, i, r, s) {
      ...
      a.color.setMask(!1),
        ...
        a.stencil.setFunc(n.ALWAYS, g, 4294967295),
  ...
  Ft = class extends S {
    constructor() {
      super("MipmapBlurPass"),
        ...
        (this.downsamplingMaterial = new ut()),
        (this.upsamplingMaterial = new Mt()),
        (this.resolution = new v());
    }
    get texture() {
      return this.renderTarget.texture;
    }
    ...
    render(e, t, i, r, s) {
      ...
      for (let A = g.length - 1; A >= 0; --A) {
        const E = g[A];
        c.setSize(f.width, f.height),
          (c.inputBuffer = f.texture),
          (c.supportBuffer = u[A].texture),
          e.setRenderTarget(E),
          e.render(n, a),
          (f = E);
      }
    ...
    setSize(e, t) {
      ...
      for (let n = 0, a = this.downsamplingMipmaps.length; n < a; ++n)
        (r = Math.round(r * 0.5)),
          (s = Math.round(s * 0.5)),
          this.downsamplingMipmaps[n].setSize(r, s),
          n < this.upsamplingMipmaps.length &&
            this.upsamplingMipmaps[n].setSize(r, s);
    }
    initialize(e, t, i) {
      if (i !== void 0) {
        const r = this.downsamplingMipmaps.concat(this.upsamplingMipmaps);
        for (const s of r) s.texture.type = i;
        if (i !== R)
          (this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1"),
            (this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
        else if (F(e) === p) for (const s of r) y(s.texture, p);
      }
    }
    dispose() {
      super.dispose();
  ...
  Lt = class {
    ...
    get delta() {
      return this._delta * ee;
    }
    get fixedDelta() {
      return this._fixedDelta * ee;
    }
    set fixedDelta(e) {
      this._fixedDelta = e * Ht;
    }
    get elapsed() {
      return this._elapsed * ee;
    }
    update(e) {
      this.useFixedDelta
  ...
  yi = class {
    ...
    setRenderer(e) {
      if (((this.renderer = e), e !== null)) {
        const t = e.getSize(new v()),
          i = e.getContext().getContextAttributes().alpha,
          r = this.inputBuffer.texture.type;
        r === R &&
          F(e) === p &&
          (y(this.inputBuffer.texture, p),
          y(this.outputBuffer.texture, p),
          this.inputBuffer.dispose(),
          this.outputBuffer.dispose()),
          (e.autoClear = !1),
          this.setSize(t.width, t.height);
        for (const s of this.passes) s.initialize(e, i, r);
      }
    }
    ...
    createBuffer(e, t, i, r) {
      const s = this.renderer,
        n = s === null ? new v() : s.getDrawingBufferSize(new v()),
        a = {
          minFilter: L,
          magFilter: L,
          stencilBuffer: t,
    ...
    addPass(e, t) {
      const i = this.passes,
        r = this.renderer,
        s = r.getDrawingBufferSize(new v()),
    ...
    removePass(e) {
      ...
      if (i !== -1 && t.splice(i, 1).length > 0) {
        if (this.depthTexture !== null) {
          const n = (o, c) => o || c.needsDepthTexture;
          t.reduce(n, !1) ||
    ...
    render(e) {
      ...
      for (const u of this.passes)
        u.enabled &&
          ...
          u.needsSwap &&
            (n &&
              ((i.renderToScreen = u.renderToScreen),
              (a = t.getContext()),
            ...
            (r = s),
            (s = c)),
          u instanceof Ot ? (n = !0) : u instanceof Rt && (n = !1));
    }
    setSize(e, t, i) {
      const r = this.renderer,
        s = r.getSize(new v());
      (e === void 0 || t === void 0) && ((e = s.width), (t = s.height)),
        (s.width !== e || s.height !== t) && r.setSize(e, t, i);
      const n = r.getDrawingBufferSize(new v());
  ...
  Gt = class {
    constructor() {
      (this.shaderParts = new Map([
        [d.FRAGMENT_HEAD, null],
        [d.FRAGMENT_MAIN_UV, null],
        [d.FRAGMENT_MAIN_IMAGE, null],
        [d.VERTEX_HEAD, null],
        [d.VERTEX_MAIN_SUPPORT, null],
      ])),
  ...
  de = class {
    ...
    cloneMaterial(e) {
      ...
      for (const s in t) {
        const n = t[s].value;
        n.isRenderTargetTexture && ((t[s].value = null), i.set(s, n));
      }
      const r = e.clone();
      for (const s of i)
    ...
    setMaterial(e) {
      if ((this.disposeMaterials(), (this.material = e), e !== null)) {
        ...
        for (const i of t)
          (i.uniforms = Object.assign({}, e.uniforms)), (i.side = Ge);
        (t[2].skinning = !0),
          (this.materialsBackSide = t.map((i) => {
            const r = this.cloneMaterial(i);
            return (
              (r.uniforms = Object.assign({}, e.uniforms)), (r.side = V), r
            );
          })),
          (this.materialsDoubleSide = t.map((i) => {
            const r = this.cloneMaterial(i);
            return (
              (r.uniforms = Object.assign({}, e.uniforms)), (r.side = X), r
            );
          })),
  ...
  U = -1,
  x = class extends se {
    constructor(e, t = U, i = U, r = 1) {
      super(),
        (this.resizable = e),
        (this.baseSize = new v(1, 1)),
        (this.preferredSize = new v(t, i)),
        (this.target = this.preferredSize),
        (this.s = r),
        (this.effectiveSize = new v()),
    ...
    set scale(e) {
      this.s !== e &&
        ((this.s = e),
        this.preferredSize.setScalar(U),
  ...
  mi = class extends se {
    ...
    getShaderCode() {
      return pi.get(this.blendFunction);
    }
  },
  ae = class extends se {
    constructor(
...
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,texel.a);}`,
  Ei = class extends ae {
    constructor({
      ...
      width: u = x.AUTO_SIZE,
      height: g = x.AUTO_SIZE,
      resolutionX: f = u,
      resolutionY: A = g,
    } = {}) {
      super("BloomEffect", Di, {
        blendFunction: e,
        uniforms: new Map([
          ["map", new l(null)],
          ["intensity", new l(s)],
        ...
        (this.blurPass = new Pe({ kernelSize: o })),
        (this.luminancePass = new Ut({ colorOutput: !0 })),
        (this.luminanceMaterial.threshold = t),
        (this.luminanceMaterial.smoothing = i),
        (this.mipmapBlurPass = new Ft()),
      ...
      const E = (this.resolution = new x(this, f, A, c));
...
function fe(e, t, i) {
  const r = document.createElement("canvas"),
    s = r.getContext("2d");
  if (((r.width = e), (r.height = t), i instanceof Image)) s.drawImage(i, 0, 0);
  else {
    const n = s.createImageData(e, t);
    n.data.set(i), s.putImageData(n, 0, 0);
  }
  return r;
}
var ge = class be {
    ...
    toCanvas() {
      return typeof document > "u"
        ? null
        : fe(this.width, this.height, this.data);
    }
    static from(t) {
...
var Pi = class {
    ...
    generate() {
      const e = !this.disableCache && window.localStorage !== void 0,
        t = e
          ? [
          ...
          : [null, null];
      return (t[0] !== null && t[1] !== null ? Promise.resolve(t) : wi(e)).then(
        (r) =>
          new Promise((s, n) => {
            const a = new Image(),
              o = new Image(),
            ...
            (c.onLoad = () => s([a, o])),
              (c.onError = n),
              a.addEventListener("error", (u) => c.itemError("smaa-search")),
              o.addEventListener("error", (u) => c.itemError("smaa-area")),
              a.addEventListener("load", () => c.itemEnd("smaa-search")),
              o.addEventListener("load", () => c.itemEnd("smaa-area")),
              c.itemStart("smaa-search"),
              c.itemStart("smaa-area"),
              (a.src = r[0]),
              (o.src = r[1]);
          })
      );
  ...
  Ci = `uniform lowp sampler2D edgeTexture;uniform lowp sampler2D maskTexture;uniform vec3 visibleEdgeColor;uniform vec3 hiddenEdgeColor;uniform float pulse;uniform float edgeStrength;
#ifdef USE_PATTERN
...
outputColor=vec4(color,max(alpha,inputColor.a));
  ...
  Ri = class extends ae {
    constructor(
      ...
      t,
      {
        ...
        width: M = x.AUTO_SIZE,
        height: C = x.AUTO_SIZE,
        resolutionX: G = M,
        resolutionY: H = C,
      } = {}
    ) {
      super("OutlineEffect", Ci, {
        uniforms: new Map([
          ["maskTexture", new l(null)],
          ["edgeTexture", new l(null)],
          ["edgeStrength", new l(n)],
          ["visibleEdgeColor", new l(new O(o))],
          ["hiddenEdgeColor", new l(new O(c))],
          ["pulse", new l(1)],
          ["patternScale", new l(s)],
          ["patternTexture", new l(null)],
        ]),
      }),
        this.blendMode.addEventListener("change", (Ue) => {
          this.blendMode.blendFunction === h.ALPHA
            ? this.defines.set("ALPHA", "1")
            : this.defines.delete("ALPHA"),
            this.setChanged();
        }),
        (this.blendMode.blendFunction = i),
        (this.patternTexture = r),
        (this.xRay = f),
        (this.scene = e),
        (this.camera = t),
        (this.renderTargetMask = new w(1, 1)),
        (this.renderTargetMask.samples = A),
        (this.renderTargetMask.texture.name = "Outline.Mask"),
        (this.uniforms.get("maskTexture").value =
          this.renderTargetMask.texture),
        (this.renderTargetOutline = new w(1, 1, { depthBuffer: !1 })),
        (this.renderTargetOutline.texture.name = "Outline.Edges"),
        (this.uniforms.get("edgeTexture").value =
          this.renderTargetOutline.texture),
        (this.clearPass = new Y()),
        (this.clearPass.overrideClearColor = new O(0)),
        (this.clearPass.overrideClearAlpha = 1),
        (this.depthPass = new ye(e, t)),
        (this.maskPass = new Ie(e, t, new nt(this.depthPass.texture, t)));
      const m = this.maskPass.clearPass;
      (m.overrideClearColor = new O(16777215)),
        (m.overrideClearAlpha = 1),
        (this.blurPass = new Pe({
          resolutionScale: E,
          resolutionX: G,
          resolutionY: H,
          kernelSize: u,
        })),
        (this.blurPass.enabled = g);
      const D = this.blurPass.resolution;
      D.addEventListener("change", (Ue) =>
        this.setSize(D.baseWidth, D.baseHeight)
      ),
        (this.outlinePass = new Z(new xt()));
      const z = this.outlinePass.fullscreenMaterial;
      (z.inputBuffer = this.renderTargetMask.texture),
        (this.time = 0),
        (this.forceUpdate = !0),
        (this.selection = new Re()),
    ...
    setSize(e, t) {
      ...
      const r = i.width,
        s = i.height;
      this.depthPass.setSize(r, s),
        this.renderTargetOutline.setSize(r, s),
        this.outlinePass.fullscreenMaterial.setSize(r, s);
    }
    initialize(e, t, i) {
      this.blurPass.initialize(e, t, R),
        i !== void 0 &&
          (this.depthPass.initialize(e, t, i),
          this.maskPass.initialize(e, t, i),
          this.outlinePass.initialize(e, t, i));
    }
  },
  bi = class extends Ei {
    constructor(e, t, i) {
      super(i),
        ...
        (this.camera = t),
        (this.depthPass = new ye(e, t)),
        (this.clearPass = new Y(!0, !1, !1)),
        (this.clearPass.overrideClearColor = new O(0)),
        (this.depthMaskPass = new Z(new ot()));
      const r = this.depthMaskMaterial;
      r.copyCameraSettings(t),
        (r.depthBuffer1 = this.depthPass.texture),
        (r.depthPacking1 = K),
        (r.depthMode = ie),
        (this.renderTargetMasked = new w(1, 1, { depthBuffer: !1 })),
    ...
    set inverted(e) {
      (this._inverted = e), (this.depthMaskMaterial.depthMode = e ? me : ie);
    }
    isInverted() {
      return this.inverted;
    }
    ...
    update(e, t, i) {
      const r = this.camera,
        ...
        n = this.inverted;
      let a = t;
      if (this.ignoreBackground || !n || s.size > 0) {
        const o = r.layers.mask;
        r.layers.set(s.layer),
          this.depthPass.render(e),
          (r.layers.mask = o),
    ...
    initialize(e, t, i) {
      super.initialize(e, t, i),
        ...
        i !== void 0 &&
          ...
          F(e) === p && y(this.renderTargetMasked.texture, p));
    }
  },
  Ae =
  ...
  Ui = class extends ae {
    constructor({
      ...
      preset: t = k.MEDIUM,
      edgeDetectionMode: i = Ce.COLOR,
      predicationMode: r = je.DISABLED,
    } = {}) {
      super("SMAAEffect", Si, {
        vertexShader: Ti,
        blendFunction: e,
        attributes: I.CONVOLUTION | I.DEPTH,
        uniforms: new Map([["weightMap", new l(null)]]),
      });
      let s, n;
      arguments.length > 1 &&
        ((s = arguments[0]),
        ...
        (this.renderTargetEdges = new w(1, 1, { depthBuffer: !1 })),
      ...
      (a.onLoad = () => {
        ...
        (c.name = "SMAA.Area"),
          ...
          (c.needsUpdate = !0),
          (c.flipY = !1),
          (this.weightsMaterial.areaTexture = c),
        ...
        s !== void 0 && n !== void 0
          ...
          : typeof Image < "u" &&
            ((s = new Image()),
            (n = new Image()),
            s.addEventListener("load", () => a.itemEnd("search")),
            n.addEventListener("load", () => a.itemEnd("area")),
            (s.src = Ae),
            (n.src = ve)),
        this.applyPreset(t);
    }
