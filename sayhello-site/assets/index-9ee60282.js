...
function ar(e) {
  const t = De(gs),
    ...
    o = _e(() => r.value > -1 && Yc(n.params, s.value.params)),
    i = _e(
      () =>
        r.value > -1 &&
  ...
  function c(l = {}) {
    return Jc(l)
      ? t[Se(e.replace) ? "replace" : "push"](Se(e.to)).catch(Ft)
      : Promise.resolve();
  }
  return {
    route: s,
  ...
  const ft = new Set(),
    Wt = {
      ...
      install(g) {
        ...
        const x = {};
        for (const q in qe) x[q] = _e(() => l.value[q]);
        g.provide(gs, C), g.provide(vs, At(x)), g.provide(Qn, l);
        const T = g.unmount;
        ft.add(g),
          (g.unmount = function () {
            ft.delete(g),
...
const pu = { class: "root-app" },
  ...
  Au = ie(
    ...
    { class: "content-us" },
    [
      ie("p", { class: "title" }, "Three.js 3d前端特效"),
      ie("p", { class: "desc" }, [
        ie("span", null, "承接数据可视化前端制作/源码出售"),
        ie("span", null, "欢迎咨询合作"),
      ]),
      ie("p", { class: "tips" }, "微信扫码，联系我们"),
    ],
    -1
  ),
  Tu = {
        ...
        (f, d) => {
          ...
          return (
            ...
            dt("div", pu, [
              ...
              Se(n).mode
                ? (tt(),
                  dt("div", { key: 0, class: "goods-buy-btn", onClick: l }, gu))
                : ml("", !0),
              ie(
                "div",
                { class: _n(["qrcode-fixed", { active: Se(n).isHover }]) },
                [
                  ie(
                    "div",
                    {
                  ...
                  ie("div", Pu, [
                    Se(n).mode ? (tt(), dt("img", Ou)) : (tt(), dt("img", Cu)),
                    Au,
                  ]),
                ],
                2
