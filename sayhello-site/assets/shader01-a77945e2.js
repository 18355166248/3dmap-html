...
import { s as _ } from "./stats.module-077ce25d.js";
import { _ as y } from "./_plugin-vue_export-helper-c27b6911.js";
import { g as x, h as g, o as P, c as M } from "./index-d838a7bb.js";
import "./lil-gui.module.min-f00c3c61.js";
const b = `// precision mediump float;\r
...
class F extends f {
  ...
  initModel() {
    let e = new m(20, 20, 20, 20);
    const n = e.attributes.position.count,
      i = new Float32Array(n);
    for (let o = 0; o < n; o++) i[o] = Math.random();
    e.setAttribute("aRandom", new u(i, 1));
    let s = new c({
        vertexShader: w,
        fragmentShader: b,
        side: l,
        uniforms: {
          uFrequency: { value: new p(100, 50) },
          uTime: { value: 0 },
        },
      }),
      t = new v(e, s);
    t.rotateX(-Math.PI / 2), this.scene.add(t);
    const a = this.debug.instance.addFolder("uFrequency");
    a.add(t.material.uniforms.uFrequency.value, "x", -100, 200, 0.01),
      a.add(t.material.uniforms.uFrequency.value, "y", 0, 100, 0.01),
      this.time.on("tick", (o, d) => {
        t.material.uniforms.uTime.value = d;
      });
  }
  update() {
...
const R = { id: "canvas" },
  ...
  k = y(q, [["__scopeId", "data-v-aa0aa86c"]]);
export { k as default };
