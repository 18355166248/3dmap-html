...
import { M as v, R as p } from "./index-1453e2ee.js";
import { D as h } from "./index-4ec0cc76.js";
...
import { g, h as x, o as w, c as P } from "./index-d838a7bb.js";
...
class F extends v {
  constructor(e) {
    super(e),
      ...
      (this.scene.background = new a("#000000")),
      this.init();
  }
  async init() {
    this.initSetting(), await this.initAssets(), this.initModel();
  }
  initSetting() {
    (this.debug = new h(!0)),
      (this.stats = new f()),
  ...
  initAssets() {
    return new Promise((e) => {
      (this.assets = new p()),
        this.assets.loadAll([{ type: "Texture", name: "flag", path: y }]),
  ...
  initModel() {
    let e = new u(20, 20, 20, 20),
      o = this.assets.getResource("flag"),
      t = new l({
        vertexShader: M,
        fragmentShader: b,
        side: d,
        transparent: !0,
        uniforms: {
          uFrequency: { value: new c(100, 50) },
          uTime: { value: 0 },
          uTexture: { value: o },
        },
      }),
      n = new m(e, t);
    n.scale.set(1, 0.5, 1), n.rotateX(-Math.PI / 2), this.scene.add(n);
    const s = this.debug.instance.addFolder("uFrequency");
    s.add(t.uniforms.uFrequency.value, "x", -100, 200, 0.01),
      s.add(t.uniforms.uFrequency.value, "y", 0, 100, 0.01),
      this.time.on("tick", (S, i) => {
...
const T = { id: "canvas" },
  ...
  I = _(C, [["__scopeId", "data-v-8b336f5a"]]);
export { I as default };
